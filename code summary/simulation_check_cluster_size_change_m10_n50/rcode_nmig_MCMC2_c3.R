...
poster_nmig_resm10_thin10_mcmc2_c3 = mclapply(1:100,nmigfunc,simdata_m10,m0=m0,iter=iter,burn=burn,thin=thin,mc.cores=20)
save(poster_nmig_resm10_thin10_mcmc2_c3,file="poster_nmig_resm10_thin10_mcmc2_c3.RData")
