...
load("ed_mimic_lassom32f_class_posterior_c1.RData")
load("ed_mimic_lassom32f_class_posterior_c2.RData")
load("ed_mimic_lassom32f_class_posterior_c3.RData")
library(MASS)
library(parallel)
library(invgamma)
library(truncnorm)
...
burn=1000
thin=10
effect_lassofunc = function(dataid,data_list,poster_res,poster_res_st2,poster_res_st3,iter=iter,burn=burn){
  set.seed(dataid)
...
effect_lassom32f_class_logscale_thin10_comb = mclapply(1:100,effect_lassofunc,simdata_m32_f,ed_mimic_lassom32f_class_posterior_c1,ed_mimic_lassom32f_class_posterior_c2,ed_mimic_lassom32f_class_posterior_c3,iter=iter,burn=burn,mc.cores=20)
save(effect_lassom32f_class_logscale_thin10_comb,file="effect_lassom32f_class_logscale_thin10_comb.RData")