...
nmig34_class_posterior = mclapply(1:4,poster34_nmig_func,data_class_as_clu_list,iter=iter,burn=burn,mc.cores=4)
save(nmig34_class_posterior,file="nmig34_class_posterior.RData")


nmig12_class_posterior = mclapply(1:4,poster12_nmig_func,data_class_as_clu_list,iter=iter,burn=burn,mc.cores=4)
