...
load("poster_naive_resm50.RData")
load("poster_naive_resm50_st2.RData")
load("poster_naive_resm50_st3.RData")
library(survival)
library(MASS)
library(parallel)
library(invgamma)
...
effect_naive_func = function(dataid,simdata){
  ...
  beta00_pos = rbind(poster_naive_resm50[[dataid]]$beta00_pos[seq((burn+1),iter,thin),],
                 poster_naive_resm50_st2[[dataid]]$beta00_pos[seq((burn+1),iter,thin),],
                 poster_naive_resm50_st3[[dataid]]$beta00_pos[seq((burn+1),iter,thin),]) 
  beta10_pos = rbind(poster_naive_resm50[[dataid]]$beta10_pos[seq((burn+1),iter,thin),],
               poster_naive_resm50_st2[[dataid]]$beta10_pos[seq((burn+1),iter,thin),],
               poster_naive_resm50_st3[[dataid]]$beta10_pos[seq((burn+1),iter,thin),])
  beta11_pos = rbind(poster_naive_resm50[[dataid]]$beta11_pos[seq((burn+1),iter,thin),],
               poster_naive_resm50_st2[[dataid]]$beta11_pos[seq((burn+1),iter,thin),],
               poster_naive_resm50_st3[[dataid]]$beta11_pos[seq((burn+1),iter,thin),])                            
  
  alpha00_pos = rbind(poster_naive_resm50[[dataid]]$alpha00_pos[seq((burn+1),iter,thin),],
               poster_naive_resm50_st2[[dataid]]$alpha00_pos[seq((burn+1),iter,thin),],
               poster_naive_resm50_st3[[dataid]]$alpha00_pos[seq((burn+1),iter,thin),])
  alpha10_pos = rbind(poster_naive_resm50[[dataid]]$alpha10_pos[seq((burn+1),iter,thin),],
               poster_naive_resm50_st2[[dataid]]$alpha10_pos[seq((burn+1),iter,thin),],
               poster_naive_resm50_st3[[dataid]]$alpha10_pos[seq((burn+1),iter,thin),]) 
  alpha01_pos = rbind(poster_naive_resm50[[dataid]]$alpha01_pos[seq((burn+1),iter,thin),],
               poster_naive_resm50_st2[[dataid]]$alpha01_pos[seq((burn+1),iter,thin),],
               poster_naive_resm50_st3[[dataid]]$alpha01_pos[seq((burn+1),iter,thin),])
  alpha11_pos = rbind(poster_naive_resm50[[dataid]]$alpha11_pos[seq((burn+1),iter,thin),],
               poster_naive_resm50_st2[[dataid]]$alpha11_pos[seq((burn+1),iter,thin),],
               poster_naive_resm50_st3[[dataid]]$alpha11_pos[seq((burn+1),iter,thin),])
...
effect_naive_resm50_thin10_comb = mclapply(1:100,effect_naive_func,simdata_m50,mc.cores=20)
save(effect_naive_resm50_thin10_comb,file="effect_naive_resm50_thin10_comb.RData")