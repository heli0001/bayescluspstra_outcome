...
poster12_nmig_func = function(dataid,data_list,iter=10000,burn=1000){
  ...
  ## starting value
  # principal strata
  beta00_pos[1,] = beta00_t
  beta10_pos[1,] = beta10_t
  beta11_pos[1,] = beta11_t
  var_beta00[1] = 100
  var_beta10[1] = 100
  var_beta11[1] = 100
  
  # outcomes
  alpha00_pos[1,] = alpha00_t
  alpha10_pos[1,] = alpha10_t
  alpha01_pos[1,] = alpha01_t
  alpha11_pos[1,] = alpha11_t
  var_alpha11[1] = 100
  var_alpha10[1] = 100
  var_alpha00[1] = 100
  var_alpha01[1] = 100
  ...
  zeta_10[1,] = zeta_10_t
  zeta_00[1,] = zeta_00_t
  zeta_y_11[1,] = zeta_y_11_t
  zeta_y_10[1,] = zeta_y_10_t
  zeta_y_01[1,] = zeta_y_01_t
  zeta_y_00[1,] = zeta_y_00_t
...
bwmimic_nmigm_posterior_c1 = mclapply(1:100,poster12_nmig_func,simdata_bw_m99,iter=iter,burn=burn,mc.cores=20)
save(bwmimic_nmigm_posterior_c1,file="bwmimic_nmigm_posterior_c1.RData")
