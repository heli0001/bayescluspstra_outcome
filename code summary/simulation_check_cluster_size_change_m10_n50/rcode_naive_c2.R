...
poster_naive_resm10_st2 = mclapply(1:100,naivefunc,simdata_m10,iter=iter,burn=burn,mc.cores = 20)
save(poster_naive_resm10_st2,file="poster_naive_resm10_st2.RData")
