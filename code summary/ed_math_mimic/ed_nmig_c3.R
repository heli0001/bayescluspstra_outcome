...
poster12_nmig_func = function(dataid,data_list,iter=10000,burn=1000){
  ...
  ## starting value
  # principal strata
  beta00_pos[1,] = beta00_t*0.99
  beta10_pos[1,] = beta10_t*0.99
  beta11_pos[1,] = beta11_t*0.99
  var_beta00[1] = 100
  var_beta10[1] = 100
  var_beta11[1] = 100
  
  # outcomes
  alpha00_pos[1,] = alpha00_t*0.99
  alpha10_pos[1,] = alpha10_t*0.99
  alpha01_pos[1,] = alpha01_t*0.99
  alpha11_pos[1,] = alpha11_t*0.99
  var_alpha11[1] = 100
  var_alpha10[1] = 100
  var_alpha00[1] = 100
  var_alpha01[1] = 100
  ...
  zeta_11[1,] = zeta_11_t*0.99
  zeta_10[1,] = zeta_10_t*0.99
  zeta_00[1,] = zeta_00_t*0.99
  zeta_y_11[1,] = zeta_y_11_t*0.99
  zeta_y_10[1,] = zeta_y_10_t*0.99
  zeta_y_01[1,] = zeta_y_01_t*0.99
  zeta_y_00[1,] = zeta_y_00_t*0.99
