...
load("get_pinclu_resm10_thincomb.RData") # first MCMC result
get_pinclu_first = get_pinclu_resm10_thincomb
library(survival)
library(MASS)
library(parallel)
library(invgamma)
...
nmigfunc = function(dataid,simdata,m0=6,iter=11000,burn=10,thin=10){
  set.seed(dataid)
...
poster_nmig_resm10_thin10_mcmc2_c2 = mclapply(1:100,nmigfunc,simdata_m10,m0=m0,iter=iter,burn=burn,thin=thin,mc.cores=20)
save(poster_nmig_resm10_thin10_mcmc2_c2,file="poster_nmig_resm10_thin10_mcmc2_c2.RData")
