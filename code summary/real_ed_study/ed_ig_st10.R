...
poster12_ig_func = function(subject,data_list,iter=10000,burn=1000){
  set.seed(subject)
...
poster34_ig_func = function(subject,data_list,iter=10000,burn=1000){
  set.seed(subject)
  data_sub = data_list[[subject]]
...
ig12_class_posterior_st10 = mclapply(1:4,poster12_ig_func,data_class_as_clu_list,iter=iter,burn=burn,mc.cores=4)
save(ig12_class_posterior_st10,file="ig12_class_posterior_st10.RData")

ig34_class_posterior_st10 = mclapply(1:4,poster34_ig_func,data_class_as_clu_list,iter=iter,burn=burn,mc.cores=4)
save(ig34_class_posterior_st10,file="ig34_class_posterior_st10.RData")
