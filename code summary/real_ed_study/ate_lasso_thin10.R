load("lasso12_class_posterior.RData")
load("lasso12_class_posterior_st2.RData")
load("lasso12_class_posterior_st3.RData")
load("lasso12_class_posterior_st4.RData")
load("lasso12_class_posterior_st5.RData")
load("lasso12_class_posterior_st6.RData")
load("lasso12_class_posterior_st7.RData")
load("lasso12_class_posterior_st8.RData")
load("lasso12_class_posterior_st9.RData")
load("lasso12_class_posterior_st10.RData")

load("lasso34_class_posterior.RData")
load("lasso34_class_posterior_st2.RData")
load("lasso34_class_posterior_st3.RData")
load("lasso34_class_posterior_st4.RData")
load("lasso34_class_posterior_st5.RData")
load("lasso34_class_posterior_st6.RData")
load("lasso34_class_posterior_st7.RData")
load("lasso34_class_posterior_st8.RData")
load("lasso34_class_posterior_st9.RData")
load("lasso34_class_posterior_st10.RData")
library(MASS)
library(parallel)
library(invgamma)
library(truncnorm)
...
effect_lassofunc = function(subject,poster_res,poster_res_st2,poster_res_st3,poster_res_st4,
...
effect_lasso12resclass_logscale_1100_thin10 = mclapply(1:4,effect_lassofunc,lasso12_class_posterior,lasso12_class_posterior_st2,lasso12_class_posterior_st3,lasso12_class_posterior_st4,lasso12_class_posterior_st5,lasso12_class_posterior_st6,lasso12_class_posterior_st7,lasso12_class_posterior_st8,lasso12_class_posterior_st9,lasso12_class_posterior_st10,iter=iter,burn=burn,mc.cores=4)
save(effect_lasso12resclass_logscale_1100_thin10,file="effect_lasso12resclass_logscale_1100_thin10.RData")

effect_lasso34resclass_logscale_1100_thin10 = mclapply(1:4,effect_lassofunc,lasso34_class_posterior,lasso34_class_posterior_st2,lasso34_class_posterior_st3,lasso34_class_posterior_st4,lasso34_class_posterior_st5,lasso34_class_posterior_st6,lasso34_class_posterior_st7,lasso34_class_posterior_st8,lasso34_class_posterior_st9,lasso34_class_posterior_st10,iter=iter,burn=burn,mc.cores=4)
save(effect_lasso34resclass_logscale_1100_thin10,file="effect_lasso34resclass_logscale_1100_thin10.RData")