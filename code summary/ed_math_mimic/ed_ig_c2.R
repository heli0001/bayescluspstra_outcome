...
poster12_ig_func = function(dataid,data_list,iter=10000,burn=1000){
  ...
  print(dataid)
  return(list(beta00_pos=beta00_pos,beta10_pos=beta10_pos,beta11_pos=beta11_pos,var_beta00=var_beta00,alpha00_pos=alpha00_pos,alpha10_pos=alpha10_pos,alpha01_pos=alpha01_pos,alpha11_pos=alpha11_pos,sigsq00_pos=sigsq00_pos,sigsq01_pos=sigsq01_pos,sigsq10_pos=sigsq10_pos,sigsq11_pos=sigsq11_pos,sigsq1=sigsq1,sigsq2=sigsq2,zeta_11=zeta_11,zeta_10=zeta_10,zeta_00=zeta_00,zeta_y_11=zeta_y_11,zeta_y_10=zeta_y_10,zeta_y_01=zeta_y_01,zeta_y_00=zeta_y_00))
  
}
ed_mimic_igm32f_class_posterior_c2 = mclapply(1:100,poster12_ig_func,simdata_m32_f,iter=iter,burn=burn,mc.cores=20)
save(ed_mimic_igm32f_class_posterior_c2,file="ed_mimic_igm32f_class_posterior_c2.RData")
