...
ed_mimic_nmigm32f_class_posterior_MCMC2_c3 = mclapply(1:100,poster12_nmig_func,simdata_m32_f,get_pinclu_resed_mimic_thincomb,iter=iter,burn=burn,mc.cores=20)
save(ed_mimic_nmigm32f_class_posterior_MCMC2_c3,file="ed_mimic_nmigm32f_class_posterior_MCMC2_c3.RData")
