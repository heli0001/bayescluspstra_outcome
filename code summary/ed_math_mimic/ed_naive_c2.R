...
poster12_naive_func = function(dataid,data_list,iter=10000,burn=1000){
  set.seed(dataid)
...
ed_mimic_naivem32f_class_posterior_c2 = mclapply(1:100,poster12_naive_func,simdata_m32_f,iter=iter,burn=burn,mc.cores=20)
save(ed_mimic_naivem32f_class_posterior_c2,file="ed_mimic_naivem32f_class_posterior_c2.RData")
