...
iter=11000
burn=1000
effect_lassofunc = function(subject,poster_res,iter=iter,burn=burn){
  set.seed(subject)
...
effect_lasso12resclass_logscale_single = mclapply(1:4,effect_lassofunc,lasso12_class_posterior,iter=iter,burn=burn,mc.cores=4)
save(effect_lasso12resclass_logscale_single,file="effect_lasso12resclass_logscale_single.RData")
effect_lasso34resclass_logscale_single = mclapply(1:4,effect_lassofunc,lasso34_class_posterior,iter=iter,burn=burn,mc.cores=4)
save(effect_lasso34resclass_logscale_single,file="effect_lasso34resclass_logscale_single.RData")