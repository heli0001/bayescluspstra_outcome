...
load("poster_nmig_resm50_thin_multi1_mcmc2.RData")
...
effect_nmigfunc = function(dataid,simdata,poster_res){
  set.seed(dataid)
...
effect_nmigresm50_thin_multi1_mcmc2 = mclapply(1:100,effect_nmigfunc,simdata_m50,poster_nmig_resm50_thin_multi1_mcmc2,mc.cores=20)
save(effect_nmigresm50_thin_multi1_mcmc2,file="effect_nmigresm50_thin_multi1_mcmc2.RData")
