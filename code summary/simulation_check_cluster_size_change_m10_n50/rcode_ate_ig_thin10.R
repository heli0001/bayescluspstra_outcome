...
load("poster_igm10.RData")
load("poster_igm10_st2.RData")
load("poster_igm10_st3.RData")
library(survival)
library(MASS)
library(parallel)
library(invgamma)
...
effect_ig_func = function(dataid,simdata){
  ...
  beta00_pos = rbind(poster_igm10[[dataid]]$beta00_pos[seq((burn+1),iter,thin),],
                 poster_igm10_st2[[dataid]]$beta00_pos[seq((burn+1),iter,thin),],
                 poster_igm10_st3[[dataid]]$beta00_pos[seq((burn+1),iter,thin),]) 
  beta10_pos = rbind(poster_igm10[[dataid]]$beta10_pos[seq((burn+1),iter,thin),],
               poster_igm10_st2[[dataid]]$beta10_pos[seq((burn+1),iter,thin),],
               poster_igm10_st3[[dataid]]$beta10_pos[seq((burn+1),iter,thin),])
  beta11_pos = rbind(poster_igm10[[dataid]]$beta11_pos[seq((burn+1),iter,thin),],
               poster_igm10_st2[[dataid]]$beta11_pos[seq((burn+1),iter,thin),],
               poster_igm10_st3[[dataid]]$beta11_pos[seq((burn+1),iter,thin),])                            
  
  alpha00_pos = rbind(poster_igm10[[dataid]]$alpha00_pos[seq((burn+1),iter,thin),],
               poster_igm10_st2[[dataid]]$alpha00_pos[seq((burn+1),iter,thin),],
               poster_igm10_st3[[dataid]]$alpha00_pos[seq((burn+1),iter,thin),])
  alpha10_pos = rbind(poster_igm10[[dataid]]$alpha10_pos[seq((burn+1),iter,thin),],
               poster_igm10_st2[[dataid]]$alpha10_pos[seq((burn+1),iter,thin),],
               poster_igm10_st3[[dataid]]$alpha10_pos[seq((burn+1),iter,thin),]) 
  alpha01_pos = rbind(poster_igm10[[dataid]]$alpha01_pos[seq((burn+1),iter,thin),],
               poster_igm10_st2[[dataid]]$alpha01_pos[seq((burn+1),iter,thin),],
               poster_igm10_st3[[dataid]]$alpha01_pos[seq((burn+1),iter,thin),])
  alpha11_pos = rbind(poster_igm10[[dataid]]$alpha11_pos[seq((burn+1),iter,thin),],
               poster_igm10_st2[[dataid]]$alpha11_pos[seq((burn+1),iter,thin),],
               poster_igm10_st3[[dataid]]$alpha11_pos[seq((burn+1),iter,thin),])                                       
  
  zeta_00 = rbind(poster_igm10[[dataid]]$zeta_00[seq((burn+1),iter,thin),],
               poster_igm10_st2[[dataid]]$zeta_00[seq((burn+1),iter,thin),],
               poster_igm10_st3[[dataid]]$zeta_00[seq((burn+1),iter,thin),])
  zeta_10 = rbind(poster_igm10[[dataid]]$zeta_10[seq((burn+1),iter,thin),],
               poster_igm10_st2[[dataid]]$zeta_10[seq((burn+1),iter,thin),],
               poster_igm10_st3[[dataid]]$zeta_10[seq((burn+1),iter,thin),]) 
  zeta_11 = rbind(poster_igm10[[dataid]]$zeta_11[seq((burn+1),iter,thin),],
               poster_igm10_st2[[dataid]]$zeta_11[seq((burn+1),iter,thin),],
               poster_igm10_st3[[dataid]]$zeta_11[seq((burn+1),iter,thin),]) 
                                         
  zeta_y_00 = rbind(poster_igm10[[dataid]]$zeta_y_00[seq((burn+1),iter,thin),],
               poster_igm10_st2[[dataid]]$zeta_y_00[seq((burn+1),iter,thin),],
               poster_igm10_st3[[dataid]]$zeta_y_00[seq((burn+1),iter,thin),]) 
  zeta_y_10 = rbind(poster_igm10[[dataid]]$zeta_y_10[seq((burn+1),iter,thin),],
               poster_igm10_st2[[dataid]]$zeta_y_10[seq((burn+1),iter,thin),],
               poster_igm10_st3[[dataid]]$zeta_y_10[seq((burn+1),iter,thin),]) 
  zeta_y_01 = rbind(poster_igm10[[dataid]]$zeta_y_01[seq((burn+1),iter,thin),],
               poster_igm10_st2[[dataid]]$zeta_y_01[seq((burn+1),iter,thin),],
               poster_igm10_st3[[dataid]]$zeta_y_01[seq((burn+1),iter,thin),]) 
  zeta_y_11 = rbind(poster_igm10[[dataid]]$zeta_y_11[seq((burn+1),iter,thin),],
               poster_igm10_st2[[dataid]]$zeta_y_11[seq((burn+1),iter,thin),],
               poster_igm10_st3[[dataid]]$zeta_y_11[seq((burn+1),iter,thin),]) 
...
effect_igm10_thin10_comb = mclapply(1:100,effect_ig_func,simdata_m10,mc.cores = 20)
save(effect_igm10_thin10_comb,file="effect_igm10_thin10_comb.RData")