...
poster12_lasso_func = function(dataid,data_list,iter=10000,burn=1000){
  ...
  print(dataid)
  return(list(beta00_pos=beta00_pos,beta10_pos=beta10_pos,beta11_pos=beta11_pos,alpha00_pos=alpha00_pos,alpha10_pos=alpha10_pos,alpha01_pos=alpha01_pos,alpha11_pos=alpha11_pos,sigsq00_pos=sigsq00_pos,sigsq01_pos=sigsq01_pos,sigsq10_pos=sigsq10_pos,sigsq11_pos=sigsq11_pos,lambdasq1=lambdasq1,lambdasq2=lambdasq2,lasso_sigsq1=lasso_sigsq1,lasso_sigsq2=lasso_sigsq2,zeta_11=zeta_11,zeta_10=zeta_10,zeta_00=zeta_00,zeta_y_11=zeta_y_11,zeta_y_10=zeta_y_10,zeta_y_01=zeta_y_01,zeta_y_00=zeta_y_00)) 
}

ed_mimic_lassom32f_class_posterior_c3 = mclapply(1:100,poster12_lasso_func,simdata_m32_f,iter=iter,burn=burn,mc.cores=20)
save(ed_mimic_lassom32f_class_posterior_c3,file="ed_mimic_lassom32f_class_posterior_c3.RData")
