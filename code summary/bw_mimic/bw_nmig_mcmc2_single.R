...
load("get_pinclu_resbw_mimic_single.RData") # first MCMC result
get_pinclu_first = get_pinclu_resbw_mimic_single
...
bwmimic_poster_nmig_res_mcmc2_single = mclapply(1:100,nmigfunc,iter=iter,burn=burn,mc.cores=20)
save(bwmimic_poster_nmig_res_mcmc2_single,file="bwmimic_poster_nmig_res_mcmc2_single.RData")
