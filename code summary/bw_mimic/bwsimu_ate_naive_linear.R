...
load("bw_poster_naive_linear_c2.RData")
load("bw_poster_naive_linear_c3.RData")
...
effect_naive_func = function(dataid,poster_res,iter=iter,poster_res_c2,poster_res_c3,burn=burn){
  set.seed(dataid)
...
effect_naive_linear_res_1100_comb = mclapply(1:100,effect_naive_func,bw_poster_naive_linear_c1,bw_poster_naive_linear_c2,bw_poster_naive_linear_c3,iter=iter,burn=burn,mc.cores=20)
save(effect_naive_linear_res_1100_comb,file="effect_naive_linear_res_1100_comb.RData")