#sub_comp = read.csv("more_cluster_induction.csv",header=T,fill=T,sep=",")
...
#data_obs = sub_comp[,c(18,19,1,12,13,8,16,20,21)] marriage, race and education, combgest
...
load("get_pinclu_resbw_mimic_thincomb.RData") # first MCMC result
get_pinclu_first = get_pinclu_resbw_mimic_thincomb
...
nmigfunc = function(dataid,iter=100,burn=0){
  ...
  ## cluster-variable indicator parameters, either 0 or 1
  ...
  print(dataid)
  return(list(beta00_pos=beta00_pos[seq((burn+1),iter,thin),],beta10_pos=beta10_pos[seq((burn+1),iter,thin),],beta11_pos=beta11_pos[seq((burn+1),iter,thin),],alpha00_pos=alpha00_pos[seq((burn+1),iter,thin),],alpha10_pos=alpha10_pos[seq((burn+1),iter,thin),],alpha01_pos=alpha01_pos[seq((burn+1),iter,thin),],alpha11_pos=alpha11_pos[seq((burn+1),iter,thin),],zeta_11=zeta_11[seq((burn+1),iter,thin),],zeta_10=zeta_10[seq((burn+1),iter,thin),],zeta_00=zeta_00[seq((burn+1),iter,thin),],zeta_y_11=zeta_y_11[seq((burn+1),iter,thin),],zeta_y_10=zeta_y_10[seq((burn+1),iter,thin),],zeta_y_01=zeta_y_01[seq((burn+1),iter,thin),],zeta_y_00=zeta_y_00[seq((burn+1),iter,thin),]))
}
bwmimic_poster_nmig_res_mcmc2_c2 = mclapply(1:100,nmigfunc,iter=iter,burn=burn,mc.cores=20)
save(bwmimic_poster_nmig_res_mcmc2_c2,file="bwmimic_poster_nmig_res_mcmc2_c2.RData")
