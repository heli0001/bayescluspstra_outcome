...
load("poster_nmig_resm50_sensi.RData")
load("poster_nmig_resm50_sensi_st2.RData")
load("poster_nmig_resm50_sensi_st3.RData")
...
effect_nmigfunc = function(dataid,simdata){
  set.seed(dataid)
  data_obs = simdata[[dataid]]$data_obs
  N = dim(data_obs)[1]
  effect_true = simdata[[dataid]]$effect_simu
  ## recall posterior results
  beta00_pos = rbind(poster_nmig_resm50_sensi[[dataid]]$beta00_pos[seq((burn+1),iter,thin),],
                 poster_nmig_resm50_sensi_st2[[dataid]]$beta00_pos[seq((burn+1),iter,thin),],
                 poster_nmig_resm50_sensi_st3[[dataid]]$beta00_pos[seq((burn+1),iter,thin),]) 
  
  beta10_pos = rbind(poster_nmig_resm50_sensi[[dataid]]$beta10_pos[seq((burn+1),iter,thin),],
                 poster_nmig_resm50_sensi_st2[[dataid]]$beta10_pos[seq((burn+1),iter,thin),],
                 poster_nmig_resm50_sensi_st3[[dataid]]$beta10_pos[seq((burn+1),iter,thin),])
  
  beta11_pos = rbind(poster_nmig_resm50_sensi[[dataid]]$beta11_pos[seq((burn+1),iter,thin),],
                 poster_nmig_resm50_sensi_st2[[dataid]]$beta11_pos[seq((burn+1),iter,thin),],
                 poster_nmig_resm50_sensi_st3[[dataid]]$beta11_pos[seq((burn+1),iter,thin),])                            
  
  alpha00_pos = rbind(poster_nmig_resm50_sensi[[dataid]]$alpha00_pos[seq((burn+1),iter,thin),],
                  poster_nmig_resm50_sensi_st2[[dataid]]$alpha00_pos[seq((burn+1),iter,thin),],
                  poster_nmig_resm50_sensi_st3[[dataid]]$alpha00_pos[seq((burn+1),iter,thin),])
  
  alpha10_pos = rbind(poster_nmig_resm50_sensi[[dataid]]$alpha10_pos[seq((burn+1),iter,thin),],
                  poster_nmig_resm50_sensi_st2[[dataid]]$alpha10_pos[seq((burn+1),iter,thin),],
                  poster_nmig_resm50_sensi_st3[[dataid]]$alpha10_pos[seq((burn+1),iter,thin),]) 
  
  alpha01_pos = rbind(poster_nmig_resm50_sensi[[dataid]]$alpha01_pos[seq((burn+1),iter,thin),],
                  poster_nmig_resm50_sensi_st2[[dataid]]$alpha01_pos[seq((burn+1),iter,thin),],
                  poster_nmig_resm50_sensi_st3[[dataid]]$alpha01_pos[seq((burn+1),iter,thin),])
  
  alpha11_pos = rbind(poster_nmig_resm50_sensi[[dataid]]$alpha11_pos[seq((burn+1),iter,thin),],
                  poster_nmig_resm50_sensi_st2[[dataid]]$alpha11_pos[seq((burn+1),iter,thin),],
                  poster_nmig_resm50_sensi_st3[[dataid]]$alpha11_pos[seq((burn+1),iter,thin),])                                       
  
  zeta_00 = rbind(poster_nmig_resm50_sensi[[dataid]]$zeta_00[seq((burn+1),iter,thin),],
              poster_nmig_resm50_sensi_st2[[dataid]]$zeta_00[seq((burn+1),iter,thin),],
              poster_nmig_resm50_sensi_st3[[dataid]]$zeta_00[seq((burn+1),iter,thin),])
  
  zeta_10 = rbind(poster_nmig_resm50_sensi[[dataid]]$zeta_10[seq((burn+1),iter,thin),],
              poster_nmig_resm50_sensi_st2[[dataid]]$zeta_10[seq((burn+1),iter,thin),],
              poster_nmig_resm50_sensi_st3[[dataid]]$zeta_10[seq((burn+1),iter,thin),]) 
  
  zeta_11 = rbind(poster_nmig_resm50_sensi[[dataid]]$zeta_11[seq((burn+1),iter,thin),],
              poster_nmig_resm50_sensi_st2[[dataid]]$zeta_11[seq((burn+1),iter,thin),],
              poster_nmig_resm50_sensi_st3[[dataid]]$zeta_11[seq((burn+1),iter,thin),]) 
                                         
  
  zeta_y_00 = rbind(poster_nmig_resm50_sensi[[dataid]]$zeta_y_00[seq((burn+1),iter,thin),],
                poster_nmig_resm50_sensi_st2[[dataid]]$zeta_y_00[seq((burn+1),iter,thin),],
                poster_nmig_resm50_sensi_st3[[dataid]]$zeta_y_00[seq((burn+1),iter,thin),]) 
  
  zeta_y_10 = rbind(poster_nmig_resm50_sensi[[dataid]]$zeta_y_10[seq((burn+1),iter,thin),],
                poster_nmig_resm50_sensi_st2[[dataid]]$zeta_y_10[seq((burn+1),iter,thin),],
                poster_nmig_resm50_sensi_st3[[dataid]]$zeta_y_10[seq((burn+1),iter,thin),]) 
  
  zeta_y_01 = rbind(poster_nmig_resm50_sensi[[dataid]]$zeta_y_01[seq((burn+1),iter,thin),],
                poster_nmig_resm50_sensi_st2[[dataid]]$zeta_y_01[seq((burn+1),iter,thin),],
                poster_nmig_resm50_sensi_st3[[dataid]]$zeta_y_01[seq((burn+1),iter,thin),]) 
  
  zeta_y_11 = rbind(poster_nmig_resm50_sensi[[dataid]]$zeta_y_11[seq((burn+1),iter,thin),],
                poster_nmig_resm50_sensi_st2[[dataid]]$zeta_y_11[seq((burn+1),iter,thin),],
                poster_nmig_resm50_sensi_st3[[dataid]]$zeta_y_11[seq((burn+1),iter,thin),])                                        
...
effect_nmigresm50_sensi_thin10_comb = mclapply(1:100,effect_nmigfunc,simdata_m50,mc.cores=20)
save(effect_nmigresm50_sensi_thin10_comb,file="effect_nmigresm50_sensi_thin10_comb.RData")
