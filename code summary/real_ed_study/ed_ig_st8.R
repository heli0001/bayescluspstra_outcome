...
ig12_class_posterior_st8 = mclapply(1:4,poster12_ig_func,data_class_as_clu_list,iter=iter,burn=burn,mc.cores=4)
save(ig12_class_posterior_st8,file="ig12_class_posterior_st8.RData")

ig34_class_posterior_st8 = mclapply(1:4,poster34_ig_func,data_class_as_clu_list,iter=iter,burn=burn,mc.cores=4)
save(ig34_class_posterior_st8,file="ig34_class_posterior_st8.RData")
