...
ed_mimic_lassom32f_class_posterior_c2 = mclapply(1:100,poster12_lasso_func,simdata_m32_f,iter=iter,burn=burn,mc.cores=20)
save(ed_mimic_lassom32f_class_posterior_c2,file="ed_mimic_lassom32f_class_posterior_c2.RData")
