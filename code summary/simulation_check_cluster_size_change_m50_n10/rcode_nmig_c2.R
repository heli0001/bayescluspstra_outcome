...
nmigfunc = function(dataid,simdata,m0=30,iter=100,burn=0){
  ...
  # principal strata
  beta00_pos[1,] = beta00_t[1:2]+0.5
  beta10_pos[1,] = beta10_t[1:2]+0.5
  beta11_pos[1,] = beta11_t[1:2]+0.5
  var_beta00[1] = 100
  var_beta10[1] = 100
  var_beta11[1] = 100
  
  # outcomes
  alpha00_pos[1,] = alpha00_t[1:3]+0.5
  alpha10_pos[1,] = alpha10_t[1:3]+0.5
  alpha01_pos[1,] = alpha01_t[1:3]+0.5
  alpha11_pos[1,] = alpha11_t[1:3]+0.5
  var_alpha11[1] = 100
  var_alpha10[1] = 100
  var_alpha00[1] = 100
  var_alpha01[1] = 100
  
  sigsq00_pos[1] = sigsq00_t+0.5
  sigsq01_pos[1] = sigsq01_t+0.5
  sigsq10_pos[1] = sigsq10_t+0.5
  sigsq11_pos[1] = sigsq11_t+0.5
  
  ## hyper cluster parameters
  zeta_11[1,] = ui*beta11_t[3]+0.5
  zeta_10[1,] = ui*beta10_t[3]+0.5
  zeta_00[1,] = ui*beta00_t[3]+0.5
  zeta_y_11[1,] = ui*alpha11_t[4]+0.5
  zeta_y_10[1,] = ui*alpha10_t[4]+0.5
  zeta_y_01[1,] = ui*alpha01_t[4]+0.5
  zeta_y_00[1,] = ui*alpha00_t[4]+0.5
...
poster_nmig_resm50_st2 = mclapply(1:100,nmigfunc,simdata_m50,m0=m0,iter=iter,burn=burn,mc.cores=20)
save(poster_nmig_resm50_st2,file="poster_nmig_resm50_st2.RData")
