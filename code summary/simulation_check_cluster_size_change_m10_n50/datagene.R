...
data_gene = function(dataid,m=10,m0=6){
  set.seed(dataid)
  #n = as.matrix(sample(6:15,m,replace=T,prob=rep(1/10,10)))
  #id = unlist(apply(n,1,seq,from=1,by=1))
  n = as.matrix(sample(rep(50,10),m,replace=T,prob=rep(1/10,10)))
  id = rep(c(1,2),m)
  clu = rep(1:m,n)
...
simdata_m10= mclapply(1:100,data_gene,m=10,m0=6,mc.cores=20)
save(simdata_m10,file="simdata_m10.RData")