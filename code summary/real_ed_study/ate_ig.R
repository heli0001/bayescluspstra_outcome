...
iter=11000
burn=1000
effect_igfunc = function(subject,poster_res,iter=iter,burn=burn){
  set.seed(subject)
...
effect_ig12res_cla_logscale_single = mclapply(1:4,effect_igfunc,ig12_class_posterior,iter=iter,burn=burn,mc.cores=4)
save(effect_ig12res_cla_logscale_single,file="effect_ig12res_cla_logscale_single.RData")
effect_ig34res_cla_logscale_single = mclapply(1:4,effect_igfunc,ig34_class_posterior,iter=iter,burn=burn,mc.cores=4)
save(effect_ig34res_cla_logscale_single,file="effect_ig34res_cla_logscale_single.RData")
