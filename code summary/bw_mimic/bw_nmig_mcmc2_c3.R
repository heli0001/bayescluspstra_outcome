...
bwmimic_poster_nmig_res_mcmc2_c3 = mclapply(1:100,nmigfunc,iter=iter,burn=burn,mc.cores=20)
save(bwmimic_poster_nmig_res_mcmc2_c3,file="bwmimic_poster_nmig_res_mcmc2_c3.RData")
