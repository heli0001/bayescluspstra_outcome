...
poster12_naive_func = function(subject,data_list,iter=10000,burn=1000){
  ...
  beta00_pos[1,] = coef(pstra_m)
  beta10_pos[1,] = coef(pstra_m)
  beta11_pos[1,] = coef(pstra_m)
  var_beta00[1] = 100
  var_beta10[1] = 100
  var_beta11[1] = 100
  ...
  alpha00_pos[1,] = coef(out_m)
  alpha10_pos[1,] = coef(out_m)
  alpha01_pos[1,] = coef(out_m)
  alpha11_pos[1,] = coef(out_m)
  var_alpha11[1] = 100
  var_alpha10[1] = 100
  var_alpha00[1] = 100
  var_alpha01[1] = 100
...
naive12_class_posterior = mclapply(1:4,poster12_naive_func,data_class_as_clu_list,iter=iter,burn=burn,mc.cores=4)
save(naive12_class_posterior,file="naive12_class_posterior.RData")

naive34_class_posterior = mclapply(1:4,poster34_naive_func,data_class_as_clu_list,iter=iter,burn=burn,mc.cores=4)
save(naive34_class_posterior,file="naive34_class_posterior.RData")
