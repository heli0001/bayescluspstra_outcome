...
load("bwmimic_poster_nmig_res_mcmc2_c1.RData")
load("bwmimic_poster_nmig_res_mcmc2_c2.RData")
load("bwmimic_poster_nmig_res_mcmc2_c3.RData")
############## MCMC #################
library(survival)
library(MASS)
library(parallel)
...
effect_nmigfunc = function(dataid,poster_res,poster_res_c2,poster_res_c3,iter=iter,burn=burn){
  set.seed(dataid)
  data_obs = simdata_bw_m99[[dataid]]$data_obs
  N = dim(data_obs)[1]
  ## recall posterior results
  beta00_pos = rbind(poster_res[[dataid]]$beta00_pos,
                 poster_res_c2[[dataid]]$beta00_pos,
                 poster_res_c3[[dataid]]$beta00_pos) 
  beta10_pos = rbind(poster_res[[dataid]]$beta10_pos,
               poster_res_c2[[dataid]]$beta10_pos,
               poster_res_c3[[dataid]]$beta10_pos)
  beta11_pos = rbind(poster_res[[dataid]]$beta11_pos,
               poster_res_c2[[dataid]]$beta11_pos,
               poster_res_c3[[dataid]]$beta11_pos)                            
  
  alpha00_pos = rbind(poster_res[[dataid]]$alpha00_pos,
               poster_res_c2[[dataid]]$alpha00_pos,
               poster_res_c3[[dataid]]$alpha00_pos)
  alpha10_pos = rbind(poster_res[[dataid]]$alpha10_pos,
               poster_res_c2[[dataid]]$alpha10_pos,
               poster_res_c3[[dataid]]$alpha10_pos) 
  alpha01_pos = rbind(poster_res[[dataid]]$alpha01_pos,
               poster_res_c2[[dataid]]$alpha01_pos,
               poster_res_c3[[dataid]]$alpha01_pos)
  alpha11_pos = rbind(poster_res[[dataid]]$alpha11_pos,
               poster_res_c2[[dataid]]$alpha11_pos,
               poster_res_c3[[dataid]]$alpha11_pos)                                       
  
  zeta_00 = rbind(poster_res[[dataid]]$zeta_00,
               poster_res_c2[[dataid]]$zeta_00,
               poster_res_c3[[dataid]]$zeta_00)
  zeta_10 = rbind(poster_res[[dataid]]$zeta_10,
               poster_res_c2[[dataid]]$zeta_10,
               poster_res_c3[[dataid]]$zeta_10) 
  zeta_11 = rbind(poster_res[[dataid]]$zeta_11,
               poster_res_c2[[dataid]]$zeta_11,
               poster_res_c3[[dataid]]$zeta_11) 
                                         
  zeta_y_00 = rbind(poster_res[[dataid]]$zeta_y_00,
               poster_res_c2[[dataid]]$zeta_y_00,
               poster_res_c3[[dataid]]$zeta_y_00) 
  zeta_y_10 = rbind(poster_res[[dataid]]$zeta_y_10,
               poster_res_c2[[dataid]]$zeta_y_10,
               poster_res_c3[[dataid]]$zeta_y_10) 
  zeta_y_01 = rbind(poster_res[[dataid]]$zeta_y_01,
               poster_res_c2[[dataid]]$zeta_y_01,
               poster_res_c3[[dataid]]$zeta_y_01) 
  zeta_y_11 = rbind(poster_res[[dataid]]$zeta_y_11,
               poster_res_c2[[dataid]]$zeta_y_11,
               poster_res_c3[[dataid]]$zeta_y_11)
...
effect_nmigres_1100_comb = mclapply(1:100,effect_nmigfunc,bwmimic_poster_nmig_res_mcmc2_c1,bwmimic_poster_nmig_res_mcmc2_c2,bwmimic_poster_nmig_res_mcmc2_c3,iter=iter,burn=burn,mc.cores=20)
save(effect_nmigres_1100_comb,file="effect_nmigres_1100_comb.RData")
