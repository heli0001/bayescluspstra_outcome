...
##################MCMC#################################
poster12_lasso_func = function(dataid,data_list,iter=10000,burn=1000){
  set.seed(dataid)
...
bwmimic_lassom_posterior_c3 = mclapply(1:100,poster12_lasso_func,simdata_bw_m99,iter=iter,burn=burn,mc.cores=20)
save(bwmimic_lassom_posterior_c3,file="bwmimic_lassom_posterior_c3.RData")
