...
load("poster_naive_resm50_thin_multi1.RData")
library(survival)
library(MASS)
library(parallel)
library(invgamma)
...
effect_naive_func = function(dataid,simdata,poster_res){
  set.seed(dataid)
...
effect_naive_resm50_thin_multi1 = mclapply(1:100,effect_naive_func,simdata_m50,poster_naive_resm50_thin_multi1,mc.cores=20)
save(effect_naive_resm50_thin_multi1,file="effect_naive_resm50_thin_multi1.RData")