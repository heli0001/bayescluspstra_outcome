...
nmig34_class_posterior_st3 = mclapply(1:4,poster34_nmig_func,data_class_as_clu_list,iter=iter,burn=burn,mc.cores=4)
save(nmig34_class_posterior_st3,file="nmig34_class_posterior_st3.RData")


nmig12_class_posterior_st3 = mclapply(1:4,poster12_nmig_func,data_class_as_clu_list,iter=iter,burn=burn,mc.cores=4)
