...
ed_mimic_naivem32f_class_posterior_c1 = mclapply(1:100,poster12_naive_func,simdata_m32_f,iter=iter,burn=burn,mc.cores=20)
save(ed_mimic_naivem32f_class_posterior_c1,file="ed_mimic_naivem32f_class_posterior_c1.RData")
