...
ig12_class_posterior_st9 = mclapply(1:4,poster12_ig_func,data_class_as_clu_list,iter=iter,burn=burn,mc.cores=4)
save(ig12_class_posterior_st9,file="ig12_class_posterior_st9.RData")

ig34_class_posterior_st9 = mclapply(1:4,poster34_ig_func,data_class_as_clu_list,iter=iter,burn=burn,mc.cores=4)
save(ig34_class_posterior_st9,file="ig34_class_posterior_st9.RData")
