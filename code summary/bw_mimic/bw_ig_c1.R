...
bwmimic_igm_posterior_c1 = mclapply(1:100,poster12_ig_func,simdata_bw_m99,iter=iter,burn=burn,mc.cores=20)
save(bwmimic_igm_posterior_c1,file="bwmimic_igm_posterior_c1.RData")
