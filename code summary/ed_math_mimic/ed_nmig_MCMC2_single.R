...
load("get_pinclu_nmigm32f_single.RData")
library(MASS)
library(parallel)
library(invgamma)
library(truncnorm)
...
ed_mimic_nmigm32f_class_posterior_MCMC2_single = mclapply(1:100,poster12_nmig_func,simdata_m32_f,get_pinclu_nmigm32f_single,iter=iter,burn=burn,mc.cores=20)
save(ed_mimic_nmigm32f_class_posterior_MCMC2_single,file="ed_mimic_nmigm32f_class_posterior_MCMC2_single.RData")
