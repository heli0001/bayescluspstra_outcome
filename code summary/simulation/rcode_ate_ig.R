...
load("poster_igm50_thin_multi1.RData")
library(survival)
library(MASS)
library(parallel)
library(invgamma)
...
effect_ig_func = function(dataid,simdata,poster_res){
  set.seed(dataid)
...
effect_igm50_thin_multi1 = mclapply(1:100,effect_ig_func,simdata_m50,poster_igm50_thin_multi1,mc.cores = 20)
save(effect_igm50_thin_multi1,file="effect_igm50_thin_multi1.RData")