load("ig12_class_posterior.RData")
load("ig12_class_posterior_st2.RData")
load("ig12_class_posterior_st3.RData")
load("ig12_class_posterior_st4.RData")
load("ig12_class_posterior_st5.RData")
load("ig12_class_posterior_st6.RData")
load("ig12_class_posterior_st7.RData")
load("ig12_class_posterior_st8.RData")
load("ig12_class_posterior_st9.RData")
load("ig12_class_posterior_st10.RData")

load("ig34_class_posterior.RData")
load("ig34_class_posterior_st2.RData")
load("ig34_class_posterior_st3.RData")
load("ig34_class_posterior_st4.RData")
load("ig34_class_posterior_st5.RData")
load("ig34_class_posterior_st6.RData")
load("ig34_class_posterior_st7.RData")
load("ig34_class_posterior_st8.RData")
load("ig34_class_posterior_st9.RData")
load("ig34_class_posterior_st10.RData")
library(MASS)
library(parallel)
library(invgamma)
library(truncnorm)
...
effect_igfunc = function(subject,poster_res,poster_res_st2,poster_res_st3,poster_res_st4,
...
effect_ig12res_cla_logscale_1100_thin10 = mclapply(1:4,effect_igfunc,ig12_class_posterior,ig12_class_posterior_st2,ig12_class_posterior_st3,ig12_class_posterior_st4,ig12_class_posterior_st5,ig12_class_posterior_st6,ig12_class_posterior_st7,ig12_class_posterior_st8,ig12_class_posterior_st9,ig12_class_posterior_st10,iter=iter,burn=burn,mc.cores=4)
save(effect_ig12res_cla_logscale_1100_thin10,file="effect_ig12res_cla_logscale_1100_thin10.RData")

effect_ig34res_cla_logscale_1100_thin10 = mclapply(1:4,effect_igfunc,ig34_class_posterior,ig34_class_posterior_st2,ig34_class_posterior_st3,ig34_class_posterior_st4,ig34_class_posterior_st5,ig34_class_posterior_st6,ig34_class_posterior_st7,ig34_class_posterior_st8,ig34_class_posterior_st9,ig34_class_posterior_st10,iter=iter,burn=burn,mc.cores=4)
save(effect_ig34res_cla_logscale_1100_thin10,file="effect_ig34res_cla_logscale_1100_thin10.RData")
