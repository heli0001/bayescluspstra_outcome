...
load("poster_lassom50_st2.RData")
load("poster_lassom50_st3.RData")
library(survival)
library(MASS)
library(parallel)
library(invgamma)
...
effect_func = function(dataid,simdata){
  ...
  beta00_pos = rbind(poster_lassom50[[dataid]]$beta00_pos[seq((burn+1),iter,thin),],
                 poster_lassom50_st2[[dataid]]$beta00_pos[seq((burn+1),iter,thin),],
                 poster_lassom50_st3[[dataid]]$beta00_pos[seq((burn+1),iter,thin),]) 
  
  beta10_pos = rbind(poster_lassom50[[dataid]]$beta10_pos[seq((burn+1),iter,thin),],
                 poster_lassom50_st2[[dataid]]$beta10_pos[seq((burn+1),iter,thin),],
                 poster_lassom50_st3[[dataid]]$beta10_pos[seq((burn+1),iter,thin),])
  
  beta11_pos = rbind(poster_lassom50[[dataid]]$beta11_pos[seq((burn+1),iter,thin),],
                 poster_lassom50_st2[[dataid]]$beta11_pos[seq((burn+1),iter,thin),],
                 poster_lassom50_st3[[dataid]]$beta11_pos[seq((burn+1),iter,thin),])                            
  
  alpha00_pos = rbind(poster_lassom50[[dataid]]$alpha00_pos[seq((burn+1),iter,thin),],
                  poster_lassom50_st2[[dataid]]$alpha00_pos[seq((burn+1),iter,thin),],
                  poster_lassom50_st3[[dataid]]$alpha00_pos[seq((burn+1),iter,thin),])
  
  alpha10_pos = rbind(poster_lassom50[[dataid]]$alpha10_pos[seq((burn+1),iter,thin),],
                  poster_lassom50_st2[[dataid]]$alpha10_pos[seq((burn+1),iter,thin),],
                  poster_lassom50_st3[[dataid]]$alpha10_pos[seq((burn+1),iter,thin),]) 
  
  alpha01_pos = rbind(poster_lassom50[[dataid]]$alpha01_pos[seq((burn+1),iter,thin),],
                  poster_lassom50_st2[[dataid]]$alpha01_pos[seq((burn+1),iter,thin),],
                  poster_lassom50_st3[[dataid]]$alpha01_pos[seq((burn+1),iter,thin),])
  
  alpha11_pos = rbind(poster_lassom50[[dataid]]$alpha11_pos[seq((burn+1),iter,thin),],
                  poster_lassom50_st2[[dataid]]$alpha11_pos[seq((burn+1),iter,thin),],
                  poster_lassom50_st3[[dataid]]$alpha11_pos[seq((burn+1),iter,thin),])                                       
  
  zeta_00 = rbind(poster_lassom50[[dataid]]$zeta_00[seq((burn+1),iter,thin),],
              poster_lassom50_st2[[dataid]]$zeta_00[seq((burn+1),iter,thin),],
              poster_lassom50_st3[[dataid]]$zeta_00[seq((burn+1),iter,thin),])
  
  zeta_10 = rbind(poster_lassom50[[dataid]]$zeta_10[seq((burn+1),iter,thin),],
              poster_lassom50_st2[[dataid]]$zeta_10[seq((burn+1),iter,thin),],
              poster_lassom50_st3[[dataid]]$zeta_10[seq((burn+1),iter,thin),]) 
  
  zeta_11 = rbind(poster_lassom50[[dataid]]$zeta_11[seq((burn+1),iter,thin),],
              poster_lassom50_st2[[dataid]]$zeta_11[seq((burn+1),iter,thin),],
              poster_lassom50_st3[[dataid]]$zeta_11[seq((burn+1),iter,thin),]) 
                                         
  
  zeta_y_00 = rbind(poster_lassom50[[dataid]]$zeta_y_00[seq((burn+1),iter,thin),],
                poster_lassom50_st2[[dataid]]$zeta_y_00[seq((burn+1),iter,thin),],
                poster_lassom50_st3[[dataid]]$zeta_y_00[seq((burn+1),iter,thin),]) 
  
  zeta_y_10 = rbind(poster_lassom50[[dataid]]$zeta_y_10[seq((burn+1),iter,thin),],
                poster_lassom50_st2[[dataid]]$zeta_y_10[seq((burn+1),iter,thin),],
                poster_lassom50_st3[[dataid]]$zeta_y_10[seq((burn+1),iter,thin),]) 
  
  zeta_y_01 = rbind(poster_lassom50[[dataid]]$zeta_y_01[seq((burn+1),iter,thin),],
                poster_lassom50_st2[[dataid]]$zeta_y_01[seq((burn+1),iter,thin),],
                poster_lassom50_st3[[dataid]]$zeta_y_01[seq((burn+1),iter,thin),]) 
  
  zeta_y_11 = rbind(poster_lassom50[[dataid]]$zeta_y_11[seq((burn+1),iter,thin),],
                poster_lassom50_st2[[dataid]]$zeta_y_11[seq((burn+1),iter,thin),],
                poster_lassom50_st3[[dataid]]$zeta_y_11[seq((burn+1),iter,thin),])  
...
effect_lasso_resm50_thin10_comb = mclapply(1:100,effect_func,simdata_m50,mc.cores=20)
save(effect_lasso_resm50_thin10_comb,file="effect_lasso_resm50_thin10_comb.RData")
