...
poster12_nmig_func = function(subject,data_list,iter=10000,burn=1000){
  ...
  beta00_pos[1,] = coef(pstra_m)[1:2]*1.05
  beta10_pos[1,] = coef(pstra_m)[1:2]*1.05
  beta11_pos[1,] = coef(pstra_m)[1:2]*1.05
  var_beta00[1] = 100
  var_beta10[1] = 100
  var_beta11[1] = 100
  ...
  alpha00_pos[1,] = coef(out_m)[1:3]*1.05
  alpha10_pos[1,] = coef(out_m)[1:3]*1.05
  alpha01_pos[1,] = coef(out_m)[1:3]*1.05
  alpha11_pos[1,] = coef(out_m)[1:3]*1.05
  var_alpha11[1] = 100
  var_alpha10[1] = 100
  var_alpha00[1] = 100
  var_alpha01[1] = 100
...
nmig34_class_posterior_st6 = mclapply(1:2,poster34_nmig_func,data_class_as_clu_list,iter=iter_34,burn=burn_34,mc.cores=4)
save(nmig34_class_posterior_st6,file="nmig34_class_posterior_st6.RData")


nmig12_class_posterior_st6 = mclapply(2,poster12_nmig_func,data_class_as_clu_list,iter=iter_12,burn=burn_12,mc.cores=4)
save(nmig12_class_posterior_st6,file="nmig12_class_posterior_st6.RData")
