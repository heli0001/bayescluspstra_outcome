...
load("get_pinclu_12_class_comb_thin10.RData") # first MCMC result
get_pinclu_first = get_pinclu_12_class_comb_thin10
...
poster_nmig_resclass12_mcmc2_st10 = mclapply(1,nmigfunc,iter=iter,burn=burn,mc.cores=20)
save(poster_nmig_resclass12_mcmc2_st10,file="poster_nmig_resclass12_mcmc2_st10.RData")
