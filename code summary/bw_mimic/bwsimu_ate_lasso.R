load("bwmimic_lassom_posterior_c1.RData")
load("bwmimic_lassom_posterior_c2.RData")
load("bwmimic_lassom_posterior_c3.RData")
...
effect_lasso_func = function(dataid,poster_res,iter=iter,poster_res_c2,poster_res_c3,burn=burn){
  set.seed(dataid)
...
effect_lasso_res_1100_comb = mclapply(1:100,effect_lasso_func,bwmimic_lassom_posterior_c1,bwmimic_lassom_posterior_c2,bwmimic_lassom_posterior_c3,iter=iter,burn=burn,mc.cores=20)
save(effect_lasso_res_1100_comb,file="effect_lasso_res_1100_comb.RData")