...
load("get_pinclu_resed_mimic_thincomb.RData")
library(MASS)
library(parallel)
library(invgamma)
library(truncnorm)
...
poster12_nmig_func = function(dataid,data_list,get_pinclu_first,iter=10000,burn=1000){
  set.seed(dataid)
  ...
  ## cluster-variable indicator parameters, no need to run, selected from 1st MCMC
...
ed_mimic_nmigm32f_class_posterior_MCMC2_c2 = mclapply(1:100,poster12_nmig_func,simdata_m32_f,get_pinclu_resed_mimic_thincomb,iter=iter,burn=burn,mc.cores=20)
save(ed_mimic_nmigm32f_class_posterior_MCMC2_c2,file="ed_mimic_nmigm32f_class_posterior_MCMC2_c2.RData")
