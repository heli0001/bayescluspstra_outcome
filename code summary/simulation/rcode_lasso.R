...
lassonaivefunc = function(dataid,simdata,iter=100,burn=0){
  ...
  lasso_sigsq1[1] = 100-1
  lambdasq2[1] = rgamma(1,shape=1,rate=0.1)
  lasso_sigsq2[1] = 100-1
...
poster_lassom50_st3 = mclapply(1:100,lassonaivefunc,simdata_m50,iter=iter,burn=burn,mc.cores=20)
save(poster_lassom50_st3,file="poster_lassom50_st3.RData")
