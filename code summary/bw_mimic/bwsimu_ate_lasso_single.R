...
effect_lasso_func = function(dataid,poster_res,iter=iter,burn=burn){
  set.seed(dataid)
...
effect_lasso_res_1100_single = mclapply(1:100,effect_lasso_func,bwmimic_lassom_posterior_c1,iter=iter,burn=burn,mc.cores=20)
save(effect_lasso_res_1100_single,file="effect_lasso_res_1100_single.RData")