...
bwmimic_nmigm_posterior_c2 = mclapply(1:100,poster12_nmig_func,simdata_bw_m99,iter=iter,burn=burn,mc.cores=20)
save(bwmimic_nmigm_posterior_c2,file="bwmimic_nmigm_posterior_c2.RData")
