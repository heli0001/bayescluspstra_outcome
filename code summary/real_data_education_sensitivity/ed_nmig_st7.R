...
nmig34_class_posterior_st7 = mclapply(1:2,poster34_nmig_func,data_class_as_clu_list,iter=iter_34,burn=burn_34,mc.cores=4)
save(nmig34_class_posterior_st7,file="nmig34_class_posterior_st7.RData")


nmig12_class_posterior_st7 = mclapply(2,poster12_nmig_func,data_class_as_clu_list,iter=iter_12,burn=burn_12,mc.cores=4)
save(nmig12_class_posterior_st7,file="nmig12_class_posterior_st7.RData")
