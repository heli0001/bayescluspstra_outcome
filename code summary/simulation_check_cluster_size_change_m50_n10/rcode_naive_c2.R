...
poster_naive_resm50_st2 = mclapply(1:100,naivefunc,simdata_m50,iter=iter,burn=burn,mc.cores = 20)
save(poster_naive_resm50_st2,file="poster_naive_resm50_st2.RData")
