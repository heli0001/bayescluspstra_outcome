...
iter=11000
burn=1000
effect_ig_func = function(dataid,poster_res,iter=iter,burn=burn){
  set.seed(dataid)
...
effect_ig_res_1100_single = mclapply(1:100,effect_ig_func,bwmimic_igm_posterior_c1,iter=iter,burn=burn,mc.cores=20)
save(effect_ig_res_1100_single,file="effect_ig_res_1100_single.RData")