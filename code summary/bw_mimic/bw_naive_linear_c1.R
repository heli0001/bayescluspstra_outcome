...
naivefunc = function(dataid,iter=100,burn=0){
  ...
  beta00_pos[1,] = coef(pstra_m)[1:6]
  beta10_pos[1,] = coef(pstra_m)[1:6]
  beta11_pos[1,] = coef(pstra_m)[1:6]
  var_beta00[1] = 100
  var_beta10[1] = 100
  var_beta11[1] = 100
  ...
  alpha00_pos[1,] = coef(out_m)[1:7]
  alpha10_pos[1,] = coef(out_m)[1:7]
  alpha01_pos[1,] = coef(out_m)[1:7]
  alpha11_pos[1,] = coef(out_m)[1:7]
  var_alpha11[1] = 100
  var_alpha10[1] = 100
  var_alpha00[1] = 100
  var_alpha01[1] = 100
...
bw_poster_naive_linear_c1 = mclapply(1:100,naivefunc,iter=iter,burn=burn,mc.cores = 20)
save(bw_poster_naive_linear_c1,file="bw_poster_naive_linear_c1.RData")