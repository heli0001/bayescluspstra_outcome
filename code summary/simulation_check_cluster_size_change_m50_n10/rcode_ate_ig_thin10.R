...
load("poster_igm50.RData")
load("poster_igm50_st2.RData")
load("poster_igm50_st3.RData")
library(survival)
library(MASS)
library(parallel)
library(invgamma)
...
effect_ig_func = function(dataid,simdata){
  set.seed(dataid)
  data_obs = simdata[[dataid]]$data_obs
  N = dim(data_obs)[1]
  effect_true = simdata[[dataid]]$effect_simu
  ## recall posterior results
  beta00_pos = rbind(poster_igm50[[dataid]]$beta00_pos[seq((burn+1),iter,thin),],
                 poster_igm50_st2[[dataid]]$beta00_pos[seq((burn+1),iter,thin),],
                 poster_igm50_st3[[dataid]]$beta00_pos[seq((burn+1),iter,thin),]) 
  beta10_pos = rbind(poster_igm50[[dataid]]$beta10_pos[seq((burn+1),iter,thin),],
               poster_igm50_st2[[dataid]]$beta10_pos[seq((burn+1),iter,thin),],
               poster_igm50_st3[[dataid]]$beta10_pos[seq((burn+1),iter,thin),])
  beta11_pos = rbind(poster_igm50[[dataid]]$beta11_pos[seq((burn+1),iter,thin),],
               poster_igm50_st2[[dataid]]$beta11_pos[seq((burn+1),iter,thin),],
               poster_igm50_st3[[dataid]]$beta11_pos[seq((burn+1),iter,thin),])                            
  
  alpha00_pos = rbind(poster_igm50[[dataid]]$alpha00_pos[seq((burn+1),iter,thin),],
               poster_igm50_st2[[dataid]]$alpha00_pos[seq((burn+1),iter,thin),],
               poster_igm50_st3[[dataid]]$alpha00_pos[seq((burn+1),iter,thin),])
  alpha10_pos = rbind(poster_igm50[[dataid]]$alpha10_pos[seq((burn+1),iter,thin),],
               poster_igm50_st2[[dataid]]$alpha10_pos[seq((burn+1),iter,thin),],
               poster_igm50_st3[[dataid]]$alpha10_pos[seq((burn+1),iter,thin),]) 
  alpha01_pos = rbind(poster_igm50[[dataid]]$alpha01_pos[seq((burn+1),iter,thin),],
               poster_igm50_st2[[dataid]]$alpha01_pos[seq((burn+1),iter,thin),],
               poster_igm50_st3[[dataid]]$alpha01_pos[seq((burn+1),iter,thin),])
  alpha11_pos = rbind(poster_igm50[[dataid]]$alpha11_pos[seq((burn+1),iter,thin),],
               poster_igm50_st2[[dataid]]$alpha11_pos[seq((burn+1),iter,thin),],
               poster_igm50_st3[[dataid]]$alpha11_pos[seq((burn+1),iter,thin),])                                       
  
  zeta_00 = rbind(poster_igm50[[dataid]]$zeta_00[seq((burn+1),iter,thin),],
               poster_igm50_st2[[dataid]]$zeta_00[seq((burn+1),iter,thin),],
               poster_igm50_st3[[dataid]]$zeta_00[seq((burn+1),iter,thin),])
  zeta_10 = rbind(poster_igm50[[dataid]]$zeta_10[seq((burn+1),iter,thin),],
               poster_igm50_st2[[dataid]]$zeta_10[seq((burn+1),iter,thin),],
               poster_igm50_st3[[dataid]]$zeta_10[seq((burn+1),iter,thin),]) 
  zeta_11 = rbind(poster_igm50[[dataid]]$zeta_11[seq((burn+1),iter,thin),],
               poster_igm50_st2[[dataid]]$zeta_11[seq((burn+1),iter,thin),],
               poster_igm50_st3[[dataid]]$zeta_11[seq((burn+1),iter,thin),]) 
                                         
  zeta_y_00 = rbind(poster_igm50[[dataid]]$zeta_y_00[seq((burn+1),iter,thin),],
               poster_igm50_st2[[dataid]]$zeta_y_00[seq((burn+1),iter,thin),],
               poster_igm50_st3[[dataid]]$zeta_y_00[seq((burn+1),iter,thin),]) 
  zeta_y_10 = rbind(poster_igm50[[dataid]]$zeta_y_10[seq((burn+1),iter,thin),],
               poster_igm50_st2[[dataid]]$zeta_y_10[seq((burn+1),iter,thin),],
               poster_igm50_st3[[dataid]]$zeta_y_10[seq((burn+1),iter,thin),]) 
  zeta_y_01 = rbind(poster_igm50[[dataid]]$zeta_y_01[seq((burn+1),iter,thin),],
               poster_igm50_st2[[dataid]]$zeta_y_01[seq((burn+1),iter,thin),],
               poster_igm50_st3[[dataid]]$zeta_y_01[seq((burn+1),iter,thin),]) 
  zeta_y_11 = rbind(poster_igm50[[dataid]]$zeta_y_11[seq((burn+1),iter,thin),],
               poster_igm50_st2[[dataid]]$zeta_y_11[seq((burn+1),iter,thin),],
               poster_igm50_st3[[dataid]]$zeta_y_11[seq((burn+1),iter,thin),]) 
...
effect_igm50_thin10_comb = mclapply(1:100,effect_ig_func,simdata_m50,mc.cores = 20)
save(effect_igm50_thin10_comb,file="effect_igm50_thin10_comb.RData")