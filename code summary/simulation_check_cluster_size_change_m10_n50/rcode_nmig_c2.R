...
nmigfunc = function(dataid,simdata,m0=6,iter=100,burn=0){
  set.seed(dataid)
...
poster_nmig_resm10_st2 = mclapply(1:100,nmigfunc,simdata_m10,m0=m0,iter=iter,burn=burn,mc.cores=20)
save(poster_nmig_resm10_st2,file="poster_nmig_resm10_st2.RData")
