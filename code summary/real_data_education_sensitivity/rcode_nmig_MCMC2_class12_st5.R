...
poster_nmig_resclass12_mcmc2_st5 = mclapply(1,nmigfunc,iter=iter,burn=burn,mc.cores=20)
save(poster_nmig_resclass12_mcmc2_st5,file="poster_nmig_resclass12_mcmc2_st5.RData")
