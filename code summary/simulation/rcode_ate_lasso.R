...
load("poster_lassom50_thin_multi1.RData")
...
effect_func = function(dataid,simdata,poster_res){
  set.seed(dataid)
...
effect_lasso_resm50_thin_multi1 = mclapply(1:100,effect_func,simdata_m50,poster_lassom50_thin_multi1,mc.cores=20)
save(effect_lasso_resm50_thin_multi1,file="effect_lasso_resm50_thin_multi1.RData")
