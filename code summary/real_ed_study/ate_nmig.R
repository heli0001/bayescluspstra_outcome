...
effect_nmigfunc = function(subject,old_res,poster_res,iter=iter,burn=burn){
  set.seed(subject)
  #data_obs = nmig_posterior[[subject]]$data_obs
  data_obs = old_res[[subject]]$data_obs
  N = dim(data_obs)[1]
  ...
  zeta_00 = poster_res[[subject]]$zeta_00
  zeta_10 = poster_res[[subject]]$zeta_10
  zeta_11 = poster_res[[subject]]$zeta_11
  zeta_y_00 = poster_res[[subject]]$zeta_y_00
  zeta_y_10 = poster_res[[subject]]$zeta_y_10
  zeta_y_01 = poster_res[[subject]]$zeta_y_01
  zeta_y_11 = poster_res[[subject]]$zeta_y_11
...
effect_nmig12res_class_logscale_single = mclapply(1:4,effect_nmigfunc,nmig12_class_posterior,poster_nmig_resclass12_mcmc2,iter=iter,burn=burn,mc.cores=4)
save(effect_nmig12res_class_logscale_single,file="effect_nmig12res_class_logscale_single.RData")
effect_nmig34res_class_logscale_single = mclapply(1:4,effect_nmigfunc,nmig34_class_posterior,poster_nmig_resclass34_mcmc2,iter=iter,burn=burn,mc.cores=4)
save(effect_nmig34res_class_logscale_single,file="effect_nmig34res_class_logscale_single.RData")
