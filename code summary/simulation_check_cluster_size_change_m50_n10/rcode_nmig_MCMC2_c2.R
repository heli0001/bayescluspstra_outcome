...
nmigfunc = function(dataid,simdata,m0=30,iter=11000,burn=10,thin=10){
  set.seed(dataid)
...
poster_nmig_resm50_thin10_mcmc2_c2 = mclapply(1:100,nmigfunc,simdata_m50,m0=m0,iter=iter,burn=burn,thin=thin,mc.cores=20)
save(poster_nmig_resm50_thin10_mcmc2_c2,file="poster_nmig_resm50_thin10_mcmc2_c2.RData")
