...
nmig34_class_posterior = mclapply(1:2,poster34_nmig_func,data_class_as_clu_list,iter=iter_34,burn=burn_34,mc.cores=4)
save(nmig34_class_posterior,file="nmig34_class_posterior.RData")


nmig12_class_posterior = mclapply(2,poster12_nmig_func,data_class_as_clu_list,iter=iter_12,burn=burn_12,mc.cores=4)
save(nmig12_class_posterior,file="nmig12_class_posterior.RData")
