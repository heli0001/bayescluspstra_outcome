...
poster12_naive_func = function(subject,data_list,iter=10000,burn=1000){
  ...
  beta00_pos[1,] = coef(pstra_m)*0.98
  beta10_pos[1,] = coef(pstra_m)*0.98
  beta11_pos[1,] = coef(pstra_m)*0.98
  var_beta00[1] = 100
  var_beta10[1] = 100
  var_beta11[1] = 100
  ...
  alpha00_pos[1,] = coef(out_m)*0.98
  alpha10_pos[1,] = coef(out_m)*0.98
  alpha01_pos[1,] = coef(out_m)*0.98
  alpha11_pos[1,] = coef(out_m)*0.98
  var_alpha11[1] = 100
  var_alpha10[1] = 100
  var_alpha00[1] = 100
  var_alpha01[1] = 100
...
naive12_class_posterior_st8 = mclapply(1:4,poster12_naive_func,data_class_as_clu_list,iter=iter,burn=burn,mc.cores=4)
save(naive12_class_posterior_st8,file="naive12_class_posterior_st8.RData")

naive34_class_posterior_st8 = mclapply(1:4,poster34_naive_func,data_class_as_clu_list,iter=iter,burn=burn,mc.cores=4)
save(naive34_class_posterior_st8,file="naive34_class_posterior_st8.RData")
