...
poster_nmig_resm10_st3 = mclapply(1:100,nmigfunc,simdata_m10,m0=m0,iter=iter,burn=burn,mc.cores=20)
save(poster_nmig_resm10_st3,file="poster_nmig_resm10_st3.RData")
