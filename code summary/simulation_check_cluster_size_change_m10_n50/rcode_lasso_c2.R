...
lassonaivefunc = function(dataid,simdata,iter=100,burn=0){
  set.seed(dataid)
  ...
  var_beta00[1] = 100+0.5
  var_beta10[1] = 100+0.5
  var_beta11[1] = 100+0.5
  ...
  var_alpha11[1] = 100+0.5
  var_alpha10[1] = 100+0.5
  var_alpha00[1] = 100+0.5
  var_alpha01[1] = 100+0.5
  ...
  lasso_sigsq1[1] = 100+0.5
  lambdasq2[1] = rgamma(1,shape=1,rate=0.1)
  lasso_sigsq2[1] = 100+0.5
  ...
  print(dataid)
  return(list(beta00_pos=beta00_pos,beta10_pos=beta10_pos,beta11_pos=beta11_pos,alpha00_pos=alpha00_pos,alpha10_pos=alpha10_pos,alpha01_pos=alpha01_pos,alpha11_pos=alpha11_pos,sigsq00_pos=sigsq00_pos,sigsq01_pos=sigsq01_pos,sigsq10_pos=sigsq10_pos,sigsq11_pos=sigsq11_pos,
...
poster_lassom10_st2 = mclapply(1:100,lassonaivefunc,simdata_m10,iter=iter,burn=burn,mc.cores=20)
save(poster_lassom10_st2,file="poster_lassom10_st2.RData")
