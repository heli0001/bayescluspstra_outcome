...
lasso12_class_posterior_st3 = mclapply(1:4,poster12_lasso_func,data_class_as_clu_list,iter=iter,burn=burn,mc.cores=4)
save(lasso12_class_posterior_st3,file="lasso12_class_posterior_st3.RData")

lasso34_class_posterior_st3 = mclapply(1:4,poster34_lasso_func,data_class_as_clu_list,iter=iter,burn=burn,mc.cores=4)
save(lasso34_class_posterior_st3,file="lasso34_class_posterior_st3.RData")
