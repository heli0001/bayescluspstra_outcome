...
poster_nmig_resclass12_mcmc2_st2 = mclapply(1,nmigfunc,iter=iter,burn=burn,mc.cores=20)
save(poster_nmig_resclass12_mcmc2_st2,file="poster_nmig_resclass12_mcmc2_st2.RData")
